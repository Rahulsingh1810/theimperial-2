...
const founders = [
  ...
  },
  {
    ...
    image: '/Tusheet.JPG',
    description:
      'Tusheet is a seasoned Investment Manager with an MBA from ISB and holds over 13 years of experience across Investment Banking and Asset Management. He is a distinguished Investment Manager with expertise in portfolio optimization, asset allocation, and risk mitigation. ',
  },
];
  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <h2 className="text-4xl  md:my-10 mb-10 text-center">Our Team</h2>
